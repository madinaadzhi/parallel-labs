...
public class BounceFrame extends JFrame {
    ...
    public BounceFrame() {
        ...
        Pocket p1 = new Pocket(canvas, Color.CYAN, 0, 0);
        canvas.add(p1);
        Pocket p2 = new Pocket(canvas, Color.CYAN, WIDTH, 0);
        canvas.add(p2);
        Pocket p3 = new Pocket(canvas, Color.CYAN, 0, HEIGHT - 100);
        canvas.add(p3);
        Pocket p4 = new Pocket(canvas, Color.CYAN, WIDTH, HEIGHT - 100);
        canvas.add(p4);

        System.out.println(
                new StringBuilder()
                        .append("In Frame Thread name = ")
        ...
        JButton buttonAddBlueBall = new JButton("Blue ball");
        JButton buttonAddRedBall = new JButton("Red ball");
